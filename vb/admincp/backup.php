...
if ($_REQUEST['do'] == 'choose')
{
	...
	print_input_row($vbphrase['path_and_file_to_save_backup_to'], 'filename', './forumbackup-' . vbdate(str_replace(array('\\', '/', ' '), '', $vbulletin->options['dateformat']), TIMENOW) . '-' . substr(md5('VBFB8C6115' . TIMENOW), 0, 5) . '.sql', 0, 60);
