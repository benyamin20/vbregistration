...
if (strlen('f4bd56929aace4523fff4f67d6f06bd1') == 32)
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', 'f4bd56929aace4523fff4f67d6f06bd1');
}
else
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', md5(strtoupper('f4bd56929aace4523fff4f67d6f06bd1')));
}
